...
// Destructor                                *
//********************************************
template <class T> DynamicQueue<T>::~DynamicQueue() { clear(); }

//********************************************
// Function enqueue inserts the value in num *
// at the rear of the queue.                 *
//********************************************
template <class T> void DynamicQueue<T>::enqueue(T item) {
...
//**********************************************
template <class T> void DynamicQueue<T>::dequeue(T &item) {
...
//*********************************************
template <class T> bool DynamicQueue<T>::isEmpty() const {
  bool status;
...
// in the queue.                             *
//********************************************
template <class T> void DynamicQueue<T>::clear() {
