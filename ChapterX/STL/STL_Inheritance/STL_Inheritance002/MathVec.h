...
public:
  ...
  // An example of templated friend functions without inline code.
  // Need to template with a different parameter name in the specification.
  template <class U>
  friend ostream &operator<<(ostream &strm, const MathVec<U> &obj);
};
...
/*
Description: Prints a mathematical vector in <>.
Parameters: A MathVec type, obj
Return: ostream object.
*/
template <class T> ostream &operator<<(ostream &strm, const MathVec<T> &obj) {
  strm << "<";
